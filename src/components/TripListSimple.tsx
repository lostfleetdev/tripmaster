...
import { Trip, TripFormData, TripStatus } from '../types';
...
const TripList: React.FC<TripListProps> = ({ trips, onTripSelect, onTripUpdate }) => {
  ...
  const getStatusColor = (status: TripStatus): "default" | "primary" | "secondary" | "error" | "info" | "success" | "warning" => {
    switch (status) {
