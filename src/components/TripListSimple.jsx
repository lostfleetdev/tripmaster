...
import { TRIP_STATUS, createEmptyTripFormData } from '../types';
import { tripService } from '../services/TripService';

/**
 * TripList component for displaying and managing trips
 * @param {Object} props - Component props
 * @param {Array} props.trips - Array of trip objects
 * @param {Function} props.onTripSelect - Callback when a trip is selected
 * @param {Function} props.onTripUpdate - Callback when trips need to be refreshed
 */
const TripList = ({ trips, onTripSelect, onTripUpdate }) => {
  ...
  const [formData, setFormData] = useState(createEmptyTripFormData());
  const [loading, setLoading] = useState(false);

  /**
   * Handle opening the context menu for a trip
   * @param {Object} event - React mouse event
  ...
  /**
   * Open the edit dialog for a specific trip
   * @param {Object} trip - Trip object to edit
   */
  ...
  /**
   * Open the delete confirmation dialog for a specific trip
   * @param {Object} trip - Trip object to delete
   */
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 1 }}>
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                label="Status"
              >
                <MenuItem value={TRIP_STATUS.PLANNED}>Planned</MenuItem>
                <MenuItem value={TRIP_STATUS.IN_PROGRESS}>In Progress</MenuItem>
                <MenuItem value={TRIP_STATUS.COMPLETED}>Completed</MenuItem>
              </Select>
            </FormControl>
          </Box>
        </DialogContent>
